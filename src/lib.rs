...
use self::entropy::{EntropyEncoder, EntropyDecoder, NopEncoder, HuffmanDecoder, Tee, BillingEncoder};
#[cfg(not(feature="no-stdlib"))]
        ...
        OutputType: CustomWrite<ErrType>
{
  let mut brotli_state = BrotliState::<AllocU8,
                                       ...
                                       Tee<AllocU8, AllocU32, HuffmanDecoder<AllocU8, AllocU32>,
                                           BillingEncoder<probability::FrequentistCDF16>>>::new_with_custom_dictionary(alloc_u8,
                                                                                                      alloc_u16,
                                                                                                      alloc_u32,
                                                                                                      alloc_hc,
                                                                                                      custom_dictionary);
